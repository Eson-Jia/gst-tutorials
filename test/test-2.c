...
int main(int argc, char *argv[])
{
    ...
    const int port = 8224;
    sprintf(pattern, "filesrc location=%s name=filesrc ! matroskademux name=m m.audio_0 ! appsink name=sink ! appsrc name=src ! udpsink host=192.168.5.180 port=%d bind-port=1234", location, port);
    pipeline =
